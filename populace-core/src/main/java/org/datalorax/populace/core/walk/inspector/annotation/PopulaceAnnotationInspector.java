 ...
 */
public class PopulaceAnnotationInspector implements AnnotationInspector {
    public static final PopulaceAnnotationInspector INSTANCE = new PopulaceAnnotationInspector();
