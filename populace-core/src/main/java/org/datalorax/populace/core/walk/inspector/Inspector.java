...
public interface Inspector {
    ...
    // Todo(v2.x): getElements should probably take either a RawField or a FieldInfo object, rather than instance, as this would allow elements to know their container type, and maintain the link to the field.  Might want a base class here, rather than an interface, to ensure the field is maintained etc.
}
