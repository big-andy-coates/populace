 ...
 * {@link org.datalorax.populace.field.visitor.FieldVisitor field visitor} interface.
 *
...
public class GraphWalker {
    ...
    /**
     * Construct using the {@link org.datalorax.populace.graph.GraphWalker.Builder builder}, which can
     ...
     *
     * @return the new {@link org.datalorax.populace.graph.GraphWalker.Builder builder} instance.
     */
    ...
    public interface Builder {
         ...
         * {@link org.datalorax.populace.field.filter.FieldFilters}, such as logical
         * {@link org.datalorax.populace.field.filter.FieldFilters#and AND} and
         * {@link org.datalorax.populace.field.filter.FieldFilters#or OR}
         *
         ...
         * {@link org.datalorax.populace.graph.inspector.Inspector inspectors} are used to obtain that set of fields
         * an object has and, for container types, the child objects it contains.
         * <p>
         * This call replaces the currently installer set of
         * {@link org.datalorax.populace.graph.inspector.Inspector inspectors}. A builder to manipulate the existing
         * {@link org.datalorax.populace.graph.inspector.Inspectors} can be obtained by calling {@link #inspectorsBuilder()}
         *
        ...
        /**
         * Obtain a {@link org.datalorax.populace.graph.inspector.Inspectors.Builder builder} initialised with the currently
         * installed {@link org.datalorax.populace.graph.inspector.Inspector inspectors}. The builder can be used to build
